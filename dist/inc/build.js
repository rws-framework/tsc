...
async function buildCLI(entries, appRoot, runspaceDir, buildDir, outFileName, cliExecDir, tsPaths = {}, isDev = false, hasRebuild = false, isVerbose = false, dynamicImports = true) {
    var _a, _b, _c;
    ...
    // Try webpack
    const webpackCfg = (0, webpack_2.configureWebpack)(entries, buildDir, outFileName, runspaceDir, tsPaths, isDev, dynamicImports);
